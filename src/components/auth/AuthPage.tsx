...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-emerald-950/20 to-gray-950 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        {/* Logo and Title */}
        <div className="text-center mb-8">
          <div className="bg-gradient-to-r from-emerald-500 to-green-500 p-3 rounded-xl inline-block mb-4">
        ...
        <div className="bg-gray-900/80 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 shadow-2xl">
          <div className="mb-6">
            ...
            <p className="text-gray-400">
              {isLogin ? 'Sign in to access your dashboard' : 'Join the FRA monitoring system'}
            </p>
          </div>
